...
*/
Vue.component("simple_footer_component_1721974942", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockchainScan - Real-time Blockchain Analysis
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with our cutting-edge blockchain monitoring and analysis tools. Get insights into the latest blockchain data as it happens. Built by experts for blockchain enthusiasts.
                    </div>
                </div>
            </div>
        </footer> 
