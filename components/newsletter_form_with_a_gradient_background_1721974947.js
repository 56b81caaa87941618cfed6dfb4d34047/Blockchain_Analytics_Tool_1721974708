Vue.component('newsletter_form_with_a_gradient_background_1721974947',
    { template: `
     <section class="py-28 relative">
       <div class="relative z-10 max-w-screen-xl mx-auto px-4 justify-between items-center gap-12 md:px-8 md:flex">
           <div class="flex-1 max-w-lg"><h3 class="text-3xl font-bold">Stay Ahead of the Blockchain Curve</h3></div>
           ...
           <form class="flex items-center gap-x-3 md:justify-end w-full max-w-md mx-auto">
               <div class="relative w-full">
                   ...
                   <div class="flex justify-end">
                        <input type="email" required placeholder="Enter your email" class="text-right w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-indigo-600 shadow-sm rounded-lg"/>
                    </div>
               </div>
               <button class="block font-medium py-2.5 px-2.5 text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow">Subscribe</button>
           </form>
           </div>
       </div>
